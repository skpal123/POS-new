...
@Directive({
    selector: '[designationCheck]',
    providers: [{
        provide: NG_ASYNC_VALIDATORS,
        useExisting: DesignationExistingCheckAsyncValidator,
        multi: true
    }, CommonService]
})
export class DesignationExistingCheckAsyncValidator implements AsyncValidator {
    ...
    validate(control: AbstractControl): Promise<ValidationErrors | null> | Observable<ValidationErrors | null> {
        debugger
        this.duplicatecheck.TableName = "Designation"
        this.duplicatecheck.ItemName = "designationId"
