...
@Directive({
    selector: '[levelIdCheck]',
    providers: [{
        provide: NG_ASYNC_VALIDATORS,
        useExisting: EducationLevelExistingCheckAsyncValidator,
        multi: true
    }, CommonService]
})
export class EducationLevelExistingCheckAsyncValidator implements AsyncValidator {
    ...
    validate(control: AbstractControl): Promise<ValidationErrors | null> | Observable<ValidationErrors | null> {
        debugger
        this.duplicatecheck.TableName = "EducationLevel"
        this.duplicatecheck.ItemName = "levelId"
