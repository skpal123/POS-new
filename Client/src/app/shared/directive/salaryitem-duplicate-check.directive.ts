...
@Directive({
    selector: '[salaryItemCheck]',
    providers: [{
        provide: NG_ASYNC_VALIDATORS,
        useExisting: SalaryItemExistingCheckAsyncValidator,
        multi: true
    }, CommonService]
})
export class SalaryItemExistingCheckAsyncValidator implements AsyncValidator {
    ...
    validate(control: AbstractControl): Promise<ValidationErrors | null> | Observable<ValidationErrors | null> {
        debugger
        this.duplicatecheck.TableName = "SalaryItem"
        this.duplicatecheck.ItemName = "salaryitemid"
