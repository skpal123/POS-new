...
@Directive({
    selector: '[itemIdCheck]',
    providers: [{
        provide: NG_ASYNC_VALIDATORS,
        useExisting: ItemExistingCheckAsyncValidator,
        multi: true
    }, CommonService]
})
export class ItemExistingCheckAsyncValidator implements AsyncValidator {
    ...
    validate(control: AbstractControl): Promise<ValidationErrors | null> | Observable<ValidationErrors | null> {
        debugger
        this.duplicatecheck.TableName = "tblInventoryItem"
        this.duplicatecheck.ItemName = "itemId"
