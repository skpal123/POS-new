...
@Directive({
    selector: '[invoiceNoCheck]',
    providers: [{
        provide: NG_ASYNC_VALIDATORS,
        useExisting: InvoicenoExistingCheckAsyncValidator,
        multi: true
    }, CommonService]
})
export class InvoicenoExistingCheckAsyncValidator implements AsyncValidator {
    ...
    validate(control: AbstractControl): Promise<ValidationErrors | null> | Observable<ValidationErrors | null> {
        debugger
        this.duplicatecheck.TableName = "tblGroupItem"
        this.duplicatecheck.ItemName = "invoiceNo"
