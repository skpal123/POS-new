...
@Directive({
    selector: '[chalanNoCheck]',
    providers: [{
        provide: NG_ASYNC_VALIDATORS,
        useExisting: ChalannoExistingCheckAsyncValidator,
        multi: true
    }, CommonService]
})
export class ChalannoExistingCheckAsyncValidator implements AsyncValidator {
    ...
    validate(control: AbstractControl): Promise<ValidationErrors | null> | Observable<ValidationErrors | null> {
        ...
        this.duplicatecheck.ItemName = "chalanNo"
