...
@Directive({
    selector: '[occupationCheck]',
    providers: [{
        provide: NG_ASYNC_VALIDATORS,
        useExisting: OccupationExistingCheckAsyncValidator,
        multi: true
    }, CommonService]
})
export class OccupationExistingCheckAsyncValidator implements AsyncValidator {
    ...
    validate(control: AbstractControl): Promise<ValidationErrors | null> | Observable<ValidationErrors | null> {
        debugger
        this.duplicatecheck.TableName = "Occupation"
        this.duplicatecheck.ItemName = "occupationid"
