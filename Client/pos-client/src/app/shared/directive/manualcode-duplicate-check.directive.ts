...
@Directive({
    selector: '[manualAccountCodeCheck]',
    providers: [{
        provide: NG_ASYNC_VALIDATORS,
        useExisting: ManualAccountCodeExistingCheckAsyncValidator,
        multi: true
    }, CommonService]
})
export class ManualAccountCodeExistingCheckAsyncValidator implements AsyncValidator {
    ...
    validate(control: AbstractControl): Promise<ValidationErrors | null> | Observable<ValidationErrors | null> {
        debugger
        this.duplicatecheck.TableName = "tblAccount"
        this.duplicatecheck.ItemName = "ManualAccountCode"
